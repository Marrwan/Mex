...
<nav className="bg-[#fff] text-black border-gray-200 ">
  <div className="flex flex-wrap items-center justify-between max-w-screen-xl p-4 mx-auto">
    ...
    <div class="hidden w-full md:block md:w-auto" id="navbar-default">
      <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg xs:bg-[#6D49FD] md:bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white  dark:border-[#fff] items-center">
        <li>
