  ...
  <div className="flex flex-wrap items-center justify-between max-w-screen-xl p-4 mx-auto">
    ...
    <div className={` ${ menu ? " " : "hidden"} w-full md:block md:w-auto` }>
      <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg xs:bg-[#6D49FD] md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white  dark:border-[#fff] items-center">
        <li>
          <a href="#" className="block py-2 pl-3 pr-4 text-white hover:bg-blue-700 w-full rounded text- md:bg-transparent md:p-0 md:text-black xs:text-white dark:text-white md:dark:text-blue-500 md:hover:text-[#6D49FD]" >Home</a>
        </li>
        <li>
